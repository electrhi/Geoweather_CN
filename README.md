...
- 왼쪽 표에는 지명, 체감온도, `meters`와 `users` 데이터에서 자동 집계한 `모뎀작업자` 목록을 표시합니다.
...
- `supabase/migrations/20260610004000_cn_weather_modem_workers_only.sql`: `users.worker_type = '모뎀작업자'`만 표시하도록 view 제한
